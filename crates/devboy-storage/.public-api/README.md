# devboy-storage public API baseline
...
```bash
cargo public-api --simplified -p devboy-storage \
  > crates/devboy-storage/.public-api/baseline.txt
```

## Diff against the baseline

```bash
cargo public-api --simplified -p devboy-storage diff \
  crates/devboy-storage/.public-api/baseline.txt
```
