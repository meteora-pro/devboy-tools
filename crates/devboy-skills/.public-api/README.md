# devboy-skills public API baseline
...
```bash
cargo public-api --simplified -p devboy-skills \
  > crates/devboy-skills/.public-api/baseline.txt
```

## Diff against the baseline

```bash
cargo public-api --simplified -p devboy-skills diff \
  crates/devboy-skills/.public-api/baseline.txt
```
