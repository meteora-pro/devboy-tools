# devboy-jira public API baseline
...
```bash
cargo public-api --simplified -p devboy-jira \
  > crates/plugins/api/jira/.public-api/baseline.txt
```

## Diff against the baseline

```bash
cargo public-api --simplified -p devboy-jira diff \
  crates/plugins/api/jira/.public-api/baseline.txt
```
