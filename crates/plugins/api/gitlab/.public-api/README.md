# devboy-gitlab public API baseline
...
```bash
cargo public-api --simplified -p devboy-gitlab \
  > crates/plugins/api/gitlab/.public-api/baseline.txt
```

## Diff against the baseline

```bash
cargo public-api --simplified -p devboy-gitlab diff \
  crates/plugins/api/gitlab/.public-api/baseline.txt
```
