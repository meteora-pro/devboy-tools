# devboy-slack public API baseline
...
```bash
cargo public-api --simplified -p devboy-slack \
  > crates/plugins/api/slack/.public-api/baseline.txt
```

## Diff against the baseline

```bash
cargo public-api --simplified -p devboy-slack diff \
  crates/plugins/api/slack/.public-api/baseline.txt
```
