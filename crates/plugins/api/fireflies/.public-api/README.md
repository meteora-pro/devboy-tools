# devboy-fireflies public API baseline
...
```bash
cargo public-api --simplified -p devboy-fireflies \
  > crates/plugins/api/fireflies/.public-api/baseline.txt
```

## Diff against the baseline

```bash
cargo public-api --simplified -p devboy-fireflies diff \
  crates/plugins/api/fireflies/.public-api/baseline.txt
```
