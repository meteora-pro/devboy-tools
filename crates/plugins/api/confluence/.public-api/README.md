# devboy-confluence public API baseline
...
```bash
cargo public-api --simplified -p devboy-confluence \
  > crates/plugins/api/confluence/.public-api/baseline.txt
```

## Diff against the baseline

```bash
cargo public-api --simplified -p devboy-confluence diff \
  crates/plugins/api/confluence/.public-api/baseline.txt
```
