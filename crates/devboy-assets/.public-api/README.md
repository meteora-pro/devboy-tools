# devboy-assets public API baseline
...
```bash
cargo public-api --simplified -p devboy-assets \
  > crates/devboy-assets/.public-api/baseline.txt
```

## Diff against the baseline

```bash
cargo public-api --simplified -p devboy-assets diff \
  crates/devboy-assets/.public-api/baseline.txt
```
