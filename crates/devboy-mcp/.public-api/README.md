# devboy-mcp public API baseline
...
```bash
cargo public-api --simplified -p devboy-mcp \
  > crates/devboy-mcp/.public-api/baseline.txt
```

## Diff against the baseline

```bash
cargo public-api --simplified -p devboy-mcp diff \
  crates/devboy-mcp/.public-api/baseline.txt
```
