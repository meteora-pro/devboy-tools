...
| [024](./ADR-024-agent-mediated-vault-access-totp-and-audit-log.md) | Agent-mediated vault access — TOTP unlock, configurable unlock window, liveness verdicts, encrypted audit log, version history, and keychain/keyring deprecation | proposed | Security, Secrets, Agent, Audit, Rotation, Core |
